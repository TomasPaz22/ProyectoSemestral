...
public class CrearCuenta extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPass_CONFIRMARContrasena1 = new javax.swing.JPasswordField();
        ...
        jPass_CONFIRMARContrasena1.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        jPass_CONFIRMARContrasena1.setForeground(new java.awt.Color(204, 204, 204));
        jPass_CONFIRMARContrasena1.setText("********");
        jPass_CONFIRMARContrasena1.setBorder(javax.swing.BorderFactory.createEtchedBorder());
        jPass_CONFIRMARContrasena1.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mousePressed(java.awt.event.MouseEvent evt) {
                jPass_CONFIRMARContrasena1MousePressed(evt);
            }
        });
        jPass_CONFIRMARContrasena1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jPass_CONFIRMARContrasena1ActionPerformed(evt);
            }
        });
        jPanel1.add(jPass_CONFIRMARContrasena1, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 240, 250, 50));
    ...
    private void jT_CorreoMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jT_CorreoMousePressed
        ...
        if(String.valueOf(jPass_CONFIRMARContrasena1.getPassword()).isEmpty()){
            jPass_CONFIRMARContrasena1.setText("********");
            jPass_CONFIRMARContrasena1.setForeground(new Color(204,204,204));
        }
    ...
    private void jPass_CONFIRMARContrasena1MousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jPass_CONFIRMARContrasena1MousePressed
        if(String.valueOf(jPass_CONFIRMARContrasena1.getPassword()).equals("********")){
            jPass_CONFIRMARContrasena1.setText("");
            jPass_CONFIRMARContrasena1.setForeground(Color.black);
        }
        if(jT_Usuario1.getText().isEmpty()){
            jT_Usuario1.setText("Ingrese su usuario");
            jT_Usuario1.setForeground(new Color(204,204,204));
    ...
    }//GEN-LAST:event_jPass_CONFIRMARContrasena1MousePressed
    ...
    private void jPass_CONFIRMARContrasena1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jPass_CONFIRMARContrasena1ActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_jPass_CONFIRMARContrasena1ActionPerformed
    ...
    private javax.swing.JPasswordField jPass_CONFIRMARContrasena1;
